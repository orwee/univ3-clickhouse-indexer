...
Numbers only, from section 1 on: what was measured, not why, and not what is acceptable. The one exception is the list right below, which interprets and says so.
...
The text, with each figure and the section of this report behind it, is `docs/RECONCILIATION_FINDINGS.md`. Titles and states only:
...
Our volume recomputed with the day cut moved from -12 h to +12 h in steps of 1 h, against the external days, over 2026-08-10 to 2026-09-24 (days complete on our side under every shift). A positive shift moves swaps from late in the day into the next day. Cell: sum of |our day - external day| divided by the external total.

| Shift (h) | wstETH/USDC 0.3% | wstETH/USDC 0.05% | USDC/WETH 0.05% | USDC/WETH 0.01% |
|---|---|---|---|---|
| -12 | 19.15% | 1.23% | 16.62% | 16.39% |
| -11 | 20.25% | 1.22% | 15.31% | 15.09% |
| -10 | 18.98% | 1.23% | 14.01% | 14.21% |
| -9 | 16.24% | 1.01% | 12.22% | 12.71% |
| -8 | 17.79% | 0.45% | 11.37% | 10.78% |
| -7 | 12.77% | 0.44% | 10.27% | 9.86% |
| -6 | 12.14% | 0.44% | 9.46% | 9.22% |
| -5 | 9.95% | 0.42% | 8.23% | 6.33% |
| -4 | 9.92% | 0.42% | 7.48% | 6.06% |
| -3 | 11.49% | 0.41% | 6.50% | 4.96% |
| -2 | 8.57% | 0.37% | 4.91% | 4.00% |
| -1 | 3.72% | 0.25% | 2.99% | 2.51% |
| +0 | 0.47% | 0.16% | 0.49% | 0.57% |
| +1 | 9.59% | 0.20% | 2.45% | 1.63% |
| +2 | 11.27% | 0.21% | 5.20% | 3.52% |
| +3 | 12.55% | 0.32% | 9.51% | 7.34% |
| +4 | 15.69% | 0.33% | 13.12% | 8.54% |
| +5 | 17.34% | 0.34% | 14.65% | 9.14% |
| +6 | 21.19% | 0.41% | 16.98% | 10.42% |
| +7 | 19.76% | 0.43% | 18.28% | 10.56% |
| +8 | 21.12% | 0.47% | 22.55% | 12.13% |
| +9 | 25.56% | 102.69% | 27.76% | 13.65% |
| +10 | 25.75% | 197.62% | 31.67% | 16.40% |
| +11 | 27.78% | 197.64% | 35.87% | 18.12% |
| +12 | 31.72% | 197.68% | 38.91% | 19.53% |

| Pool | Shift with the smallest value | Value there | Value at shift 0 |
|---|---|---|---|
| wstETH/USDC 0.3% | +0 h | 0.47% | 0.47% |
| wstETH/USDC 0.05% | +0 h | 0.16% | 0.16% |
| USDC/WETH 0.05% | +0 h | 0.49% | 0.49% |
| USDC/WETH 0.01% | +0 h | 0.57% | 0.57% |
...
|---|---|---|---|---|---|---|---|---|
| wstETH/USDC 0.3% | 927 | 3 | 92,118 | 91,892 | -0.2453% | -8.0947% | -0.0154% | +4.5800% |
| wstETH/USDC 0.05% | 6,096 | 0 | 26,398,380 | 26,394,560 | -0.0145% | -1.3923% | +0.0024% | +1.3924% |
| USDC/WETH 0.05% | 307,146 | 0 | 3,709,409,986 | 3,709,487,033 | +0.0021% | -0.0520% | -0.0269% | +0.0510% |
| USDC/WETH 0.01% | 926,414 | 0 | 2,256,005,098 | 2,265,909,793 | +0.4390% | -0.0336% | -0.0001% | +0.0348% |
...
|---|---|---|---|---|---|---|
| USDC/WETH 0.01% | 46 | -2.04% | -0.22% | +0.10% | +0.62% | +3.14% |
| wstETH/USDC 0.3% | 45 | -6.75% | -0.32% | -0.02% | +0.12% | +1.21% |
| wstETH/USDC 0.05% | 46 | -25.02% | -0.09% | +0.01% | +1.34% | +121.53% |
| USDC/WETH 0.05% | 46 | -0.15% | -0.03% | +0.08% | +0.44% | +2.63% |
...
|---|---|---|---|---|---|---|---|
| low | 61 | 2 to 98 | -25.02% | -0.32% | -0.01% | +0.19% | +121.53% |
| middle | 61 | 105 to 7,281 | -17.69% | -0.06% | +0.08% | +0.69% | +17.84% |
| high | 61 | 7,304 to 26,431 | -2.04% | -0.04% | +0.04% | +0.49% | +3.14% |
...
| USDC/WETH 0.05% | 2026-09-25 | 70 | 247,353 | 498,790 | -50.41% |
| USDC/WETH 0.01% | 2026-08-09 | 3,476 | 4,895,431 | 14,720,866 | -66.74% |
| USDC/WETH 0.01% | 2026-09-25 | 158 | 269,501 | 1,067,485 | -74.75% |

Our first swap: 2026-08-09 18:35:11 UTC. Our last swap: 2026-09-25 00:09:47 UTC.
...
|---|---|---|---|---|
| wstETH/USDC 0.3% | 931 | 1 | 0 | 0.000000 |
| wstETH/USDC 0.05% | 6,096 | 0 | 0 | 0.000000 |
| USDC/WETH 0.05% | 307,171 | 25 | 0 | 0.000016 |
| USDC/WETH 0.01% | 926,420 | 6 | 0 | 0.000000 |

Pool-days present on one side only: 2.
- wstETH/USDC 0.3% 2026-08-09: only_external
- wstETH/USDC 0.05% 2026-09-25: only_external
...
Days with every pool of the pair compared: 46.
...
Pair-days beyond 1%: 4 of 46. Pair daily rel diff: min, p25, median, p75, max = -0.88% | -0.03% | +0.19% | +0.60% | +2.10%.

### wstETH/USDC: wstETH/USDC 0.3% + wstETH/USDC 0.05%

Days with every pool of the pair compared: 45.
...
Pair-days beyond 1%: 20 of 45. Pair daily rel diff: min, p25, median, p75, max = -17.73% | -0.14% | +0.02% | +1.34% | +120.32%.
...
|---|---|---|---|---|---|---|---|
| 2026-08-10 | Mon | 0.99x | -0.08% | +0.42% | +9.64% | +0.36% |  |
| 2026-08-11 | Tue | 0.65x | +1.31% | -0.02% | -9.01% | +0.15% |  |
| 2026-08-12 | Wed | 0.95x | +0.29% | -0.02% | +1.57% | +0.13% |  |
| 2026-08-13 | Thu | 0.78x | +0.49% | -0.21% | -0.02% | +0.76% |  |
| 2026-08-14 | Fri | 0.72x | +2.82% | +0.12% | -1.34% | +0.03% |  |
| 2026-08-15 | Sat | 0.33x | +1.01% |  | -0.00% | -0.04% |  |
| 2026-08-16 | Sun | 0.32x | +0.80% | -0.44% | -0.09% | -0.03% |  |
| 2026-08-17 | Mon | 1.00x | +0.18% | -0.32% | +121.53% | +0.79% |  |
| 2026-08-18 | Tue | 0.82x | +0.66% | +0.19% | -0.01% | +0.44% |  |
| 2026-08-19 | Wed | 3.35x | +0.27% | +1.21% | -0.09% | +2.63% |  |
| 2026-08-20 | Thu | 2.03x | +0.03% | -0.43% | +0.69% | +1.07% |  |
| 2026-08-21 | Fri | 2.58x | +0.47% | -0.81% | +2.10% | +0.12% |  |
| 2026-08-22 | Sat | 1.57x | +0.06% | +0.86% | -0.18% | +0.08% |  |
| 2026-08-23 | Sun | 1.36x | +0.01% | +0.01% | -7.82% | +0.40% |  |
| 2026-08-24 | Mon | 1.50x | +0.92% | -0.29% | +2.04% | +0.60% |  |
| 2026-08-25 | Tue | 1.25x | +0.25% | -0.03% | -2.44% | +0.93% |  |
| 2026-08-26 | Wed | 0.94x | -0.60% | -0.32% | +1.60% | +0.19% |  |
| 2026-08-27 | Thu | 1.17x | -1.65% | -0.31% | -0.06% | +1.35% |  |
| 2026-08-28 | Fri | 1.11x | -0.65% | +0.94% | -0.14% | +0.93% |  |
| 2026-08-29 | Sat | 0.43x | +1.80% | -0.12% | +1.34% | +1.44% | << |
| 2026-08-30 | Sun | 0.93x | +2.03% | +0.07% | +1.05% | +0.08% |  |
| 2026-08-31 | Mon | 0.89x | +0.65% | -6.75% | +1.71% | +0.63% |  |
| 2026-09-01 | Tue | 0.94x | +0.62% | +0.19% | -0.08% | +0.64% |  |
| 2026-09-02 | Wed | 0.96x | +0.20% | +0.18% | +0.55% | +0.33% |  |
| 2026-09-03 | Thu | 1.24x | +1.59% | -0.81% | -17.69% | -0.15% |  |
| 2026-09-04 | Fri | 1.18x | -0.01% | +0.73% | +2.55% | -0.02% |  |
| 2026-09-05 | Sat | 0.41x | -0.32% | -0.31% | +0.33% | +0.02% |  |
| 2026-09-06 | Sun | 0.79x | -0.55% | +0.00% | +6.85% | -0.01% |  |
| 2026-09-07 | Mon | 0.82x | -2.04% | +0.36% | +0.02% | -0.03% |  |
| 2026-09-08 | Tue | 0.81x | -0.05% | +0.08% | -0.07% | -0.04% |  |
| 2026-09-09 | Wed | 1.06x | +0.10% | -0.14% | +0.51% | -0.07% |  |
| 2026-09-10 | Thu | 0.87x | -0.02% | -0.30% | -0.00% | -0.03% |  |
| 2026-09-11 | Fri | 2.02x | +3.14% | -0.76% | -0.11% | +0.36% |  |
| 2026-09-12 | Sat | 0.38x | -0.31% | -1.81% | -5.05% | +0.04% |  |
| 2026-09-13 | Sun | 0.53x | -0.04% | -0.34% | -0.17% | -0.03% |  |
| 2026-09-14 | Mon | 1.20x | +0.01% | -0.58% | +0.40% | -0.05% |  |
| 2026-09-15 | Tue | 1.37x | -0.22% | -0.09% | -0.06% | -0.05% |  |
| 2026-09-16 | Wed | 1.35x | -1.27% | +0.02% | +0.48% | +0.01% |  |
| 2026-09-17 | Thu | 1.00x | -0.79% | -0.01% | -0.02% | +0.01% |  |
| 2026-09-18 | Fri | 1.45x | +0.14% | +0.06% | +0.01% | +0.02% |  |
| 2026-09-19 | Sat | 0.94x | -0.55% | -0.82% | +17.84% | -0.01% |  |
| 2026-09-20 | Sun | 1.03x | +0.36% | -0.02% | +0.28% | +0.01% |  |
| 2026-09-21 | Mon | 1.85x | +0.01% | +0.77% | +9.18% | +0.25% |  |
| 2026-09-22 | Tue | 1.28x | +0.13% | -0.58% | +0.86% | -0.09% |  |
| 2026-09-23 | Wed | 1.14x | -0.02% | +0.91% | +0.01% | -0.04% |  |
| 2026-09-24 | Thu | 1.21x | -0.36% | +0.03% | -25.02% | +0.02% |  |
...
| wstETH/USDC 0.05% | 2026-09-21 | +9.18% | 683 | 0 | 0 |
| wstETH/USDC 0.05% | 2026-09-24 | -25.02% | -3,508 | 0 | 0 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| USDC/WETH 0.01% | 926,420 | 1 | 5 | 16 | 183 | 1,099 | 16,028 | 5,494 | 2,985 | 1,788 | 793 | 272 | 132 |
| USDC/WETH 0.05% | 307,171 | 1 | 5 | 16 | 42 | 92 | 672 | 1,030 | 167 | 23 | 8 | 2 | 0 |
| wstETH/USDC 0.05% | 6,096 | 21 | 73 | 991 | 6,914 | 7,842 | 7,842 | 2,576 | 1,068 | 387 | 213 | 98 | 59 |
| wstETH/USDC 0.3% | 931 | 37 | 200 | 6,997 | 1,082,989 | 1,082,989 | 1,082,989 | 584 | 339 | 178 | 93 | 55 | 41 |
...
| wstETH/USDC 0.05% | 2026-09-24 | -25.02% | -3,508 | 5 | 9,674 | -94.01% | +0.27% |
...
### All 183 compared pool-days

Pearson correlation of the daily difference (ours - external, USD) with:

- the USD of displaced swaps (H1): +0.221
- ours minus ours valued at the reference (H2): +0.245
...
|---|---|---|---|
| USDC/WETH 0.01% | 46 | -0.069 | +0.784 |
| wstETH/USDC 0.3% | 45 | -0.231 | +0.969 |
| wstETH/USDC 0.05% | 46 | -0.410 | -0.777 |
| USDC/WETH 0.05% | 46 | +0.821 | -0.159 |
...
|---|---|---|---|
| H1: leave out swaps displaced beyond 25 ticks | 0 of 25 | 0 of 12 | 139 of 146 |
| H1: leave out swaps displaced beyond 50 ticks | 1 of 25 | 0 of 12 | 119 of 146 |
| H1: leave out swaps displaced beyond 100 ticks | 0 of 25 | 0 of 12 | 97 of 146 |
| H1: leave out swaps displaced beyond 200 ticks | 0 of 25 | 0 of 12 | 72 of 146 |
| H1: leave out swaps displaced beyond 500 ticks | 1 of 25 | 0 of 12 | 46 of 146 |
| H1: leave out swaps displaced beyond 1000 ticks | 0 of 25 | 0 of 12 | 30 of 146 |
| H2: value every swap at the reference tick | 13 of 25 | 10 of 12 | 10 of 146 |
...
| wstETH/USDC 0.05% | 2026-09-24 | 15:12:11 | 26048128 | 103, 133 | no | 0x140022b7… | yes | 4,787 | 4,787 | -0 | -195245 > -203034 > -195275 | 1.96e+14 > 1.74e+14 > 1.96e+14 | 1 |
...
| wstETH/USDC 0.05% | 2026-09-24 | -3,508 | 1 | 9,574 |
...
| wstETH/USDC 0.05% | 2026-09-24 | -3,508 | -3,508 | 1 of 23 | 15h: -3,508, 16h: -0, 07h: +0 | +100.00% |
...
| wstETH/USDC 0.05% | 2026-09-24 | -25.02% | -3,508 | 5 | 9,674 | +0.27% | 15h: -3,508 | +0.03% |
